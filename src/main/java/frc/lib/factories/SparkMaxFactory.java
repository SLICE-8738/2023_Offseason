...
import frc.lib.config.REVConfigs.SparkMaxConfiguration;
...
public class SparkMaxFactory {
    ...
    public static CANSparkMax createSparkMax(int id, SparkMaxConfiguration config) {
        ...
        handleREVLibError(id, sparkMax.setPeriodicFramePeriod(CANSparkMaxLowLevel.PeriodicFrame.kStatus0, config.statusFrame0PeriodMs), "set status0 rate");
        handleREVLibError(id, sparkMax.setPeriodicFramePeriod(CANSparkMaxLowLevel.PeriodicFrame.kStatus1, config.statusFrame1PeriodMs), "set status1 rate");
        handleREVLibError(id, sparkMax.setPeriodicFramePeriod(CANSparkMaxLowLevel.PeriodicFrame.kStatus2, config.statusFrame2PeriodMs), "set status2 rate");
