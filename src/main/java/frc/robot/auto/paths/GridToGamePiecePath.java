    ...
    public GridToGamePiecePath(AutoSelector.StartingPosition startPosition) {
        ...
        switch (startPosition) {
            ...
            case BLUE_COMMUNITY_LEFT:
                trajectory = PathPlanner.loadPath("Blue Left Grid To Game Piece", new PathConstraints(3.0, 2.0));
                break;
            case BLUE_COMMUNITY_MIDDLE:
                trajectory = PathPlanner.loadPath("Blue Middle Grid To Game Piece", new PathConstraints(3.0, 2.0));
                break;
            ...
            case RED_COMMUNITY_MIDDLE:
                trajectory = PathPlanner.loadPath("Red Middle Grid To Game Piece", new PathConstraints(3.0, 2.0));
                break;
            case RED_COMMUNITY_RIGHT:
                trajectory = PathPlanner.loadPath("Red Right Grid To Game Piece", new PathConstraints(3.0, 2.0));
                break;
            default:
                break;
