...
public class ScoreOneConeHighRowThenEngageMode extends SequentialCommandGroup {
  /** Creates a new ScoreOneConeHighRowMode. */
  public ScoreOneConeHighRowThenEngageMode(Drivetrain drivetrain, Elevator elevator, Arm arm, Intake intake) {
