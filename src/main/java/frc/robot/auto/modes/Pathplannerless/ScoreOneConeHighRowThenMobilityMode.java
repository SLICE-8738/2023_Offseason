...
public class ScoreOneConeHighRowThenMobilityMode extends SequentialCommandGroup {
  /** Creates a new ScoreOneConeHighRowMode. */
  public ScoreOneConeHighRowThenMobilityMode(Drivetrain drivetrain, Elevator elevator, Arm arm, Intake intake) {
